...
См. файл diagram_context.yaml в корневой папке проекта.
...
См. файл container_context.yaml в корневой папке проекта.

**Диаграмма компонентов (Components)**

См. файл component_diagram.yaml в корневой папке проекта.
...
См. файл er_diagram.yaml в корневой папке проекта.
